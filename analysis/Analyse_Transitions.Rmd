...
FFp = paste("=",permutationResults[permutationResults$game=="Final Fantasy X-2",]$f2f.p)
if(FFp <= 0.001){
  FFp = "< 0.001"
}
FF.FFX2Stats = paste0(
...
FFp = paste("=",permutationResults[permutationResults$game=="Final Fantasy X-2",]$m2m.p)
if(FFp <= 0.001){
  FFp = "< 0.001"
}
MM.FFX2Stats = paste0(
