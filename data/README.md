...
| FinalFantasy/FFX/ | :arrow_down: |  :x: | :x: | :x: | :ok: | :ok: | :x: |
| FinalFantasy/FFX2/ | :white_check_mark: |  :ok: | :ok: | :ok: | :ok: | :ok: | :ok: |
| FinalFantasy/FFXII/ | :arrow_down: |  :x: | :x: | :x: | :ok: | :ok: | :x: |
...
| Horizon/HorizonZeroDawn/ | :parking: |  :ok: | :ok: | :ok: | :ok: | :ok: | :ok: |
| KingdomHearts/KingdomHearts/ | :parking: |  :ok: | :x: | :x: | :ok: | :ok: | :ok: |
...
| MassEffect/MassEffect3C/ | :arrow_down: |  :ok: | :ok: | :ok: | :ok: | :ok: | :ok: |
...
| Tales/TalesOfVesperia/ | :white_check_mark: |  :x: | :ok: | :ok: | :ok: | :x: | :ok: |
